...
const allowedExactFiles = new Set([
  ...
  'CREDITS.md',
  'DATA_POLICY.md',
  'DOCS/active/proxy-evidence-phase-20260809/context.md',
  'DOCS/active/proxy-evidence-phase-20260809/plan.md',
  'DOCS/active/proxy-evidence-phase-20260809/proxy-evaluation-report.md',
  'DOCS/active/proxy-evidence-phase-20260809/task.md',
  'LICENSE',
  'README.md',
  'THIRD_PARTY_NOTICES.md',
  'USER_STUDY_PROTOCOL.md',
