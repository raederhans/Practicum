...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `C:\Users\raede\.codex\worktrees\f00e\Practicum` | Nightlight UI Phase A / `019fec40-8293-7eb3-b03c-224ddcd85e6f` | `codex/nightlight-ui-ux-base` / `962431b680845a91b0b5b96807c77630dc82dd89` | detached / `962431b680845a91b0b5b96807c77630dc82dd89` | Repair Shell, navigation, focus, and accessibility behavior | `in-progress` | `App.vue`, `main.js`, static-shell tests; port 5181 | Lane-owned targeted tests and browser behavior | Must not edit D-owned CSS or B/C content views | A | Return a complete `ready-for-integration` delivery; do not stage, commit, or change refs |
| `C:\Users\raede\.codex\worktrees\fd8e\Practicum` | Nightlight UI Phase B / `019fec40-8293-7eb3-b03c-226d54ef8486` | `codex/nightlight-ui-ux-base` / `962431b680845a91b0b5b96807c77630dc82dd89` | detached / `962431b680845a91b0b5b96807c77630dc82dd89` | Improve information hierarchy, long-page structure, and progressive disclosure | `in-progress` | Overview, Findings, Methods, Credits views; ports 5182 | Lane-owned content/routes tests and browser checks | Declared hooks only; must not edit D-owned CSS | B | Return a complete `ready-for-integration` delivery; do not stage, commit, or change refs |
| `C:\Users\raede\.codex\worktrees\2a26\Practicum` | Nightlight UI Phase C / `019fec42-d0b0-7c92-9ed3-15176c8c3785` | `codex/nightlight-ui-ux-base` / `962431b680845a91b0b5b96807c77630dc82dd89` | detached / `962431b680845a91b0b5b96807c77630dc82dd89` | Improve Atlas task flow, mobile state, and URL persistence | `in-progress` | `AtlasView.vue`, directly necessary Atlas domain files; port 5183 | Lane-owned Atlas tests and browser checks | Must not edit D-owned CSS or A/B-owned views | C | Return a complete `ready-for-integration` delivery; do not stage, commit, or change refs |
| `C:\Users\raede\.codex\worktrees\feae\Practicum` | Nightlight UI Phase D / `019fec40-b5ad-72b3-8be4-212c26dd35eb` | `codex/nightlight-ui-ux-base` / `962431b680845a91b0b5b96807c77630dc82dd89` | detached / `962431b680845a91b0b5b96807c77630dc82dd89` | Consolidate visual tokens, responsive system, and future hook styles | `in-progress` | `main.css`, `index.html`, platform-boundary tests; port 5184 | Lane-owned boundary/build/browser checks | Exclusive stylesheet owner; must support declared A/B/C hooks | D | Return a complete `ready-for-integration` delivery; do not stage, commit, or change refs |
